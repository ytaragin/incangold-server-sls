...
class GameManager {
    ...
    async updateGame(gameID, gameFunc) {
        ...
        await this.saveGameInstance({fullID: gameID, game:gameInst})
    ...
    async registerPlayerInGame(gameID, player) {
        return this.updateGame(gameID, gameInst => {
